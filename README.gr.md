...
Η επιτάχυνση των επιπέδων χρέους σε όλο τον κόσμο έχει ξεκινήσει πριν την οικονομική κρίση που προκλήθηκε από τον Covid-19. To πρώτο τρίμηνο του 2020 είδαμε το παγκόσμιο χρέος να αυξάνεται στα 258 τρισεκατομμύρια. Σύμφωνα με το IIF, που αντιπροσωπεύει τις παγκόσμιες τράπεζες και χρηματοοικονομικά ινστιτούτα, αυτός ο αριθμός είναι 331% παραπάνω από το παγκόσμιο ακαθάριστο προϊόν (ΑΕΠ).  Με το Federal Reserve (κεντρική τράπεζα των ΗΠΑ) να λειτουργεί με το πρόσχημα ότι έχουν άπειρη ποσότητα χρημάτων και τον ευφημισμός “ο εκτυπωτής χρημάτων πάει μπρρρρ” να προσθέτεται στο κοινό λεξικό, είναι προφανές ότι αυτοί οι αριθμοί θα αυξηθούν και η έκδοση χρέους σε σύγκριση με το ΑΕΠ θα συνεχίσει να επιταχύνεται.

Το παραδοσιακό χρηματοοικονομικό σύστημα βιώνει μια ιστορική αύξηση σε συνολικά επίπεδα χρέους ενώ οι αποδόσεις και τα επιτόκια πέφτουν κατακόρυφα. Εν τω μεταξύ, υπάρχει ένα αποκεντρωμένο χρηματοοικονομικό σύστημα, που αναφέρεται ως DeFi σε αυτό το άρθρο, που ανθίζει στην ψηφιακή οικονομία με τα ψηφιακά περιουσιακά στοιχεία και κρυπτονομίσματα. Ενώ τα επίπεδα χρέους, τα οποία αναφέρονται ως TVL ή συνολική κλειδωμένη αξία στα αποκεντρωμένα χρηματοοικονομικά πρωτόκολλα, έχει αυξηθεί από εκατοντάδες εκατομμύρια τον περασμένο χρόνο, σε δισεκατομμύρια δολαρίων μέσα στο 2020, οι αποδόσεις σε αυτά τα όργανα συνεχίζει να ξεπερνάει κατά πολύ τα ταπεινά επιτόκια που προσφέρονται από αντίστοιχα προϊόντα στο παραδοσιακό χρηματοοικονομικό σύστημα. Αντίστροφα, εξαιτίας των υψηλότερων επιπέδων ρίσκου μαζί με την μεγαλύτερη αποδοτικότητα που παρέχεται από τις τεχνολογίες έξυπνων συμβολαίων (smart contracts), η ετήσια ποσοστιαία απόδοση (APY) είναι πολύ υψηλότερη σε αποκεντρωμένα πρωτόκολλα από ο,τι μπορεί να βρεθεί στο παραδοσιακό χρηματοοικονομικό σύστημα. Το ενεργό κεφάλαιο ακολουθεί την ιστορική τάση του κυνηγιού υψηλών αποδόσεων το οποίο είναι γιατί βλέπουμε το TVL να μεταπηδάει στο DeFi με επιταχυμένο ρυθμό. Αυτή είναι μια τάση που θα συνεχιστεί.
...
Αυτός ο ακόλουθος DAO ίσως χρειαστεί να έχει πολλαπλές συγκεκριμένες λειτουργίες που το Εταιρικό Πρότυπο του Aragon DAO δεν έχει ακόμα. Αυτός είναι ο λόγος που πιθανόν θα διαλέξουμε έναν τρόπο που κάνει ανανεώσιμα τα έξυπνα συμβόλαια (όπως το [EIP-2535](https://eips.ethereum.org/EIPS/eip-2535)), το οποίο θα μας βοηθήσει να προσθέσουμε, ανανεώσουμε, ή αφαιρέσουμε λειτουργίες στην πλατφόρμα που βάσει των επιθυμιών της κοινότητας.

Ο BarnBridge DAO θα γίνει το κύριο συστατικό της πλατφόρμας επειδή θα είναι ικανός να πάρει αποφάσεις μέσω ενός αποκεντρωμένου τρόπου όπου θα είναι ικανός να επιβάλλει τις καλύτερες δράσεις για την ευεξία της κοινότητας.
